...
arivera@pigeon:~/arivera/Scripts/Venn$ nano 3wayvenn.R 
arivera@pigeon:~/arivera/Scripts/Venn$ nano 4wayvenn.R 

  GNU nano 2.3.1                                                    File: 4wayvenn.R                                                                                                              

# Three-way comparisons
n123 <- intersect(n12, n3)
n124 <- intersect(n12, n4)
n134 <- intersect(n13, n4)
n234 <- intersect(n23, n4)
###########################################################
###########################################################

# Four-way comparisons
n1234 <- intersect(n123, n4)
write.table(n1234, file=paste(outfile, "_allcommon.txt", sep=""), sep="\t", row.names=FALSE, col.names=FALSE, quote=FALSE)
#immune_signaling <- setdiff(setdiff(n12, n13), n24)
#print(immune_signaling)
#write.table(immune_signaling, file="Immune_System_Signaling.txt", sep="\t", row.names=FALSE, col.names=FALSE, quote=FALSE)
#signaling_only <- setdiff(setdiff(setdiff(n1, n12), n13), n14)
#print(signaling_only)
#write.table(signaling_only, file="Signaling_only.txt", sep="\t", row.names=FALSE, col.names=FALSE, quote=FALSE)
##########################################################
##########################################################
# Draw venn diagram
...
cat.col <- rep("black", 4)
pdf(output)
draw.quad.venn(length(n1),length(n2),length(n3),length(n4),length(n12),length(n13),length(n14),length(n23),length(n24),length(n34),length(n123),length(n124),length(n134),length(n234),length(n12$
dev.off()
