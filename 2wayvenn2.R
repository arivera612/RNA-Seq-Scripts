...
arivera@pigeon:~/arivera/Scripts/Venn$ nano 2wayvenn2.R 
  ...
  GNU nano 2.3.1                                                   File: 2wayvenn2.R                                                                                                              
...
main= "Venn Diagram for 2-way comparison"
cat.col <- rep("black", 2)
png(output, height=1000, width=1000)
draw.pairwise.venn(n1,n2,n12, cat.col=cat.col, fill=fill, category=category, cex=4, fontfamily=rep("arial",3), cat.cex=4, cat.fontfamily=rep("arial",2), cat.pos=c(-15,15), cat.dist=rep(0.05, 2))
dev.off()
